...
module.exports = (__webpack_require__(19))(8);
...
module.exports = vendor_0db3e95c8848311dd343;
...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(18), __webpack_require__(17), __webpack_require__(61)) :
...
module.exports = (__webpack_require__(19))(117);
...
var BaseCpn = function (_Component) {
  (0, _inherits3.default)(BaseCpn, _Component);

  function BaseCpn(props) {
    (0, _classCallCheck3.default)(this, BaseCpn);
    return (0, _possibleConstructorReturn3.default)(this, (BaseCpn.__proto__ || (0, _getPrototypeOf2.default)(BaseCpn)).call(this, props));
  }
  ...
  (0, _createClass3.default)(BaseCpn, [{
    key: 'navPush',
    value: function navPush(path, props) {
    ...
    key: 'getNavPassedProps',
    value: function getNavPassedProps() {
...
Object.defineProperty(exports, "__esModule", { value: true });
var serializr_1 = __webpack_require__(44);
function _walk(v) {
...
var _TestCpn = __webpack_require__(110);

var _TestCpn2 = _interopRequireDefault(_TestCpn);

var _Test2Cpn = __webpack_require__(111);

var _Test2Cpn2 = _interopRequireDefault(_Test2Cpn);

var _stores = __webpack_require__(112);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/first', exact: true, component: _TestCpn2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/second', component: _Test2Cpn2.default })
                )
            );
        }
    }]);
...
module.exports = (__webpack_require__(19))(0);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(13)(Function.call, __webpack_require__(41).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
module.exports = (__webpack_require__(19))(203);
...
var _BaseCpn2 = __webpack_require__(62);

var _BaseCpn3 = _interopRequireDefault(_BaseCpn2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TestCpn = (_dec = (0, _mobxReact.inject)('TestStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_BaseCpn) {
    (0, _inherits3.default)(TestCpn, _BaseCpn);

    function TestCpn(props) {
        (0, _classCallCheck3.default)(this, TestCpn);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TestCpn.__proto__ || (0, _getPrototypeOf2.default)(TestCpn)).call(this, props));

        _this._onClickDoSomething = _this._onClickDoSomething.bind(_this);
        _this._onClickGetInfo = _this._onClickGetInfo.bind(_this);
        _this._onClickGoTest2 = _this._onClickGoTest2.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(TestCpn, [{
        key: '_onClickDoSomething',
        value: function _onClickDoSomething() {
            console.log(this.props);
            this.props.TestStore.doSomething();
        }
    }, {
        key: '_onClickGetInfo',
        value: function _onClickGetInfo() {
            this.props.TestStore.getInfo().then(function (data) {
                console.log(data);
                console.log('end');
            });
        }
        ...
        key: '_onClickGoTest2',
        value: function _onClickGoTest2() {
            this.navPush('/second', { name: 'zhang' });
        }
    }, {
        key: 'render',
        value: function render() {
            var _props$TestStore = this.props.TestStore,
                name = _props$TestStore.name,
                age = _props$TestStore.age;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this._onClickDoSomething },
                    'do something'
                ),
                _react2.default.createElement(
                    'button',
                    { onClick: this._onClickGetInfo },
                    'get info'
                ),
                _react2.default.createElement(
                    'button',
                    { onClick: this._onClickGoTest2 },
                    'go Test2'
                )
            );
        }
    ...
    return TestCpn;
}(_BaseCpn3.default)) || _class) || _class);
exports.default = TestCpn;
...
var Test2Cpn = (_dec = (0, _mobxReact.inject)('TestPersist', 'TestStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_BaseCpn) {
    (0, _inherits3.default)(Test2Cpn, _BaseCpn);

    function Test2Cpn(props) {
        (0, _classCallCheck3.default)(this, Test2Cpn);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Test2Cpn.__proto__ || (0, _getPrototypeOf2.default)(Test2Cpn)).call(this, props));

        _this._onClickIncrease = _this._onClickIncrease.bind(_this);
        return _this;
    }

    (0, _createClass3.default)(Test2Cpn, [{
        key: '_onClickIncrease',
        value: function _onClickIncrease() {
...
var _TestStore = __webpack_require__(113);

var _TestStore2 = _interopRequireDefault(_TestStore);

var _TestPersist = __webpack_require__(137);

var _TestPersist2 = _interopRequireDefault(_TestPersist);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var stores = {
    TestStore: _TestStore2.default,
    TestPersist: _TestPersist2.default
};
...
var _api = __webpack_require__(135);
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return _api2.default.getProfile();
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'age', [_mobx.observable], {
    enumerable: true,
    initializer: function initializer() {
        return 18;
    }
}), _applyDecoratedDescriptor(_class.prototype, 'doSomething', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'doSomething'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'getInfo', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'getInfo'), _class.prototype)), _class);
exports.default = new TestStore();
...
var api = {
    getProfile: function getProfile() {
        return fetch(_config2.default._GET_PROFILE, { method: 'POST' }).then(function (response) {
...
var _mobxPersist = __webpack_require__(138);
...
var TestPersist = (_class = function () {
    function TestPersist() {
        (0, _classCallCheck3.default)(this, TestPersist);
    ...
    (0, _createClass3.default)(TestPersist, [{
        key: 'increase',
    ...
    return TestPersist;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'name', [_mobxPersist.persist, _mobx.observable], {
    enumerable: true,
    initializer: function initializer() {
        return 'llw';
    }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'age', [_mobxPersist.persist, _mobx.observable], {
    enumerable: true,
    initializer: function initializer() {
        return 18;
    }
}), _applyDecoratedDescriptor(_class.prototype, 'increase', [_mobx.action], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'increase'), _class.prototype)), _class);


var testPersist = new TestPersist();

(0, _mobxPersist.create)({})('TestPersist', testPersist);

exports.default = testPersist;
...
var merge_x_1 = __webpack_require__(140);
var types_1 = __webpack_require__(69);
var persist_object_1 = __webpack_require__(141);
function persist() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    return function hydrate(key, store, initialState) {
        ...
        var hydration = storage.getItem(key)
            ...
            if (persisted && typeof persisted === 'object') {
                serializr_1.update(serializr_1.getDefaultModelSchema(store), store, persisted);
            }
